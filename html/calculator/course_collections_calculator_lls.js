...
function getCopies(results,res,shl,stl) {
  ...
  var totalCopies = "<h3>NEW COPIES TO ORDER: " + results + "</H3>New for Reserve: " + toRes +" <br>New for Short Loan: " + toShl + "<br>" + "New For Standard Loan: " + toStl +"<br><h3>MOVES TO MEET RATIO OF "+gridResTotal+" "+gridShlTotal+" "+gridStlTotal +"</h3>Reserve Copies to Move: "+moveExistingRes+"<br>Short Loan copies to Move: "+moveExistingShl+"<br>Standard Loan copies to Move: "+moveExistingStl;
  return totalCopies;
