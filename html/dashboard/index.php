...
<html>
	<head>
		...
		<link rel='stylesheet' id='googlefonts-css'  href='https://fonts.googleapis.com/css?family=Crimson+Pro:400|Source+Sans+Pro:400&subset=latin' media='all' />

	</head>
	<body>
	<div class='banner'>	
		<span><img src='lucid_logo.png' height='125px'></span>
		<p>&nbsp;</p>
	</div>
	<h1>Draft Library Dashboard</h1>
<p>Not for public use. If you're interested please contact <a href='mailto:information.systems@ed.ac.uk'>information.systems@ed.ac.uk</a></p>
<?php
include("number_box.php");
...
<?php	/* If there's a chart (and associated javascript), create a canvas and script for it */
		if ($format!="Table" && $format!="None" && $format != "NumberBox" && file_exists($js['chart.js'])) {
