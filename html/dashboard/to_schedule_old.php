...
// 	}
	...
	/* Alma Top Ten Borrowed Items */
		$rowset = getAlmaRows('/shared/University of Edinburgh/Reports/API/Boyuan/BOYUAN_TWO_A');
		if ($rowset) {
			$widget = array(
				'id' => 'top_ten',
				'title' => 'Top Ten Items',
				'headers' => array("Column0","Column1", "Column2", "Title","Site","No. Loans"),
				'note' => "TEST",
				'format' => "Table",
				'tags' => array("library"),
	...
	/* Resource List views by School by year */
		$rowset = getAlmaRows('/shared/University of Edinburgh/Reports/API/Boyuan/BOYUAN_THREE_A');
		if ($rowset) {
			$widget = array(
				'id' => 'top_ten_lists',
				'title' => 'Resource List views by School by year',
				'headers' => array("Column0","Year", "School", "Views"),
				'note' => "TEST",
				'format' => "Line",
				'tags' => array("library","resource lists"),
			
				);
			doTable($rowset,$widget);
		}		
	/* Top ten e-resource titles */
		$rowset = getAlmaRows('/shared/University of Edinburgh/Reports/API/Boyuan/BOYUAN_SIX_A');
		if ($rowset) {
			$widget = array(
				'id' => 'top_ten_eresource_titles',
				'title' => 'Top ten e-resource titles',
				'headers' => array("Column0","Titles", "Total"),
				'note' => "Top Ten",
				'format' => "Table",
				'tags' => array("library","resource lists"),
