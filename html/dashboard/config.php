...
$site_url = 'http://www.sysweb.lib.ed.ac.uk/dashboard';				// the URL where you'll display this dashboard
...
$csv_download_folder = 'http://www.sysweb.lib.ed.ac.uk/dashboard/csvs/';						// full web-accessible filepath to the same folder, eg 'http://example.com/LTLstats/csvs/';

/* Styles */
$widgetColour = 'plain'; // 'plain' or 'sequential' or 'by_tags' - NB if a widget has multiple tags, the colour of the alphabetically-last tag will be applied
$darkColours = array('#4aaa42','#0069b4','#a877b2','#b94d30','#261c02','dodgerblue');
$paleColours = array('#b3d88c','#b2cee7','#b5b2d9','#ffdd00','#dadada','tomato');
$darkChart = array('#4aaa42','#0069b4','#a877b2','#b94d30','#261c02','goldenrod');
$paleChart = array("rgba(179,216,140,0.2)","rgba(178,206,231,0.2)","rgba(181,178,217,0.2)","rgba(255,221,0,0.2)","rgba(218,218,218,0.2)","yellow");

/* Charts */
$js['chart.js'] = 'js/Chart.js';		// eg 'js/Chart.js' - download from http://www.chartjs.org/
$js['wordcloud2.js'] = 'js/wordcloud2.js';	// eg 'js/wordcloud2.js' - download from http://timdream.org/wordcloud2.js/
...
$alma_domain = 'https://api-eu.hosted.exlibrisgroup.com'; 			 //eg 'https://api-na.hosted.exlibrisgroup.com';
$alma_url = $alma_domain . '/almaws/v1/analytics/reports';
$alma_apikey = 'l7xx67f6e81af6034a39a7346f6bb7368502';			// your API key for Alma Analytics
